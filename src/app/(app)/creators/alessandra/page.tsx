...
export const metadata: Metadata = {
  ...
  description:
    "Decks by Alessandra Gagliano & Anthony Holt (Jocu) in the Card Guy Archive collection.",
};
...
export default async function AlessandraLandingPage() {
  ...
  return (
    <DecksLandingPage
      ...
      path="/creators/alessandra"
      heroImageUrl={ALESSANDRA_HERO_IMAGE_URL}
      blurb={ALESSANDRA_BLURB}
      description={ALESSANDRA_BLURB}
      decks={decks}
      coins={coins}
      showFilters
    />
